...
<html>
    ...
    <style type="text/css">
        ...
        background-image: url("assets/images/banners/web-sites.jpg");
...
<nav aria-label="breadcrumb" style="margin-left: 12px; margin-top: 16px;">
  <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" style="font-family: padrao;" aria-current="page">Criação de Web Sites</li>
  </ol>
</nav>
...
<div class="quem-somos" style="padding: 10px 10px 10px 10px;">
    ...
    <h1 class="page-header" style="margin-left: 10px;">Criação de <em>Web Sites</em></h1>
    <div class="box-01-total" style="margin-left:-450px; margin-top: -58px"> 
        <div class="box-01">
            <div class="conteudo">
                <div class="linha">
                    <div class="barra" style="background-color: darkgoldenrod;">
                    </div>
                </div> <!-- Linha -->
            </div>
        </div>
...
-moz-box-shadow: 2px 3px 4px 0px rgba(0,0,0,0.75);">
            <figure class="text-center">
                ...
                <figcaption class="blockquote-footer">
                  Erlandson F. A. Andrade <cite title="Source Title"></cite>
                </figcaption>
            </figure>
        </div>
    </div>
