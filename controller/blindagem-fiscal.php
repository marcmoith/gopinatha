...
and open the template in the editor.http://localhost/n_gopinatha/inventario-de-estoques
-->
<html>
    <head>
        <meta charset="UTF-8">
    ...
    <style type="text/css">
        ...
        background-image: url("assets/images/banners/blindagem-fiscal.jpg");
...
<nav aria-label="breadcrumb" style="margin-left: 12px; margin-top: 16px;">
  <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" style="font-family: padrao;" aria-current="page">Blindagem Fiscal</li>
  </ol>
</nav>
...
<div class="quem-somos" style="padding: 10px 10px 10px 10px;">
    ...
    <h1 class="page-header" style="margin-left: 10px;">Blindagem Fiscal</h1>
    <div class="box-01-total" style="margin-left:-450px; margin-top: -58px"> 
        <div class="box-01">
            <div class="conteudo">
                <div class="linha">
                    <div class="barra" style="background-color: #fe2712;">
                    </div>
                </div> <!-- Linha -->
            </div>
        </div>
...
-moz-box-shadow: 2px 3px 4px 0px rgba(0,0,0,0.75);">
            <figure class="text-center">
                ...
                <figcaption class="blockquote-footer">
                  Marco Aurélio <cite title="Source Title">(121d.C.-180d.C.)</cite>
                </figcaption>
            </figure>
        </div>
    </div>
