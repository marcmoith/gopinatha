...
<html>
    ...
    <style type="text/css">
        ...
        background-image: url("assets/images/banners/assessoria.jpg");
...
<nav aria-label="breadcrumb" style="margin-left: 12px; margin-top: 16px;">
  <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" style="font-family: padrao;" aria-current="page">Assessoria</li>
  </ol>
</nav>
...
<div class="quem-somos" style="padding: 10px 10px 10px 10px;">
    ...
    <h1 class="page-header" style="margin-left: 10px;">Assessoria</h1>
    <div class="box-01-total" style="margin-left:-450px; margin-top: -58px"> 
        <div class="box-01">
            <div class="conteudo">
                <div class="linha">
                    <div class="barra" style="background-color: chartreuse;">
                    </div>
                </div> <!-- Linha -->
            </div>
        </div>
...
-moz-box-shadow: 2px 3px 4px 0px rgba(0,0,0,0.75);">
            <figure class="text-center">
                ...
                <figcaption class="blockquote-footer">
                  Cícero <cite title="Source Title">(106a.C.-43a.C.)</cite>
                </figcaption>
            </figure>
        </div>
    </div>
