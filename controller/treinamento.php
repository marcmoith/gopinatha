...
<html>
    ...
    <style type="text/css">
        ...
        background-image: url("assets/images/banners/treinamento.jpg");
...
<nav aria-label="breadcrumb" style="margin-left: 12px; margin-top: 16px;">
  <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" style="font-family: padrao;" aria-current="page">Treinamento</li>
  </ol>
</nav>
...
<div class="quem-somos" style="padding: 10px 10px 10px 10px;">
    ...
    <h1 class="page-header" style="margin-left: 10px;">Treinamento</h1>
    <div class="box-01-total" style="margin-left:-450px; margin-top: -58px"> 
        <div class="box-01">
            <div class="conteudo">
                <div class="linha">
                    <div class="barra" style="background-color: deeppink;">
                    </div>
                </div> <!-- Linha -->
            </div>
        </div>
...
-moz-box-shadow: 2px 3px 4px 0px rgba(0,0,0,0.75);">
            <figure class="text-center">
                <blockquote class="blockquote">
                  <p>
                    As únicas grandes companhias que conseguirão ter êxito são aquelas que considerarem 
                    os seus produtos obsoletos antes que os outros o façam.
                  </p>
                </blockquote>
                <figcaption class="blockquote-footer">
                  Bill Gates <cite title="Source Title">(1955- )</cite>
                </figcaption>
            </figure>
        </div>
    </div>
