                ...
                <div class="container">
                    <div class="timetable">
                      ...
                      <ul class="m-0 nav nav-fill nav-justified nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item active" role="presentation">Seg</li>
                        <li class="nav-item" role="presentation">Ter</li>
                        <li class="nav-item" role="presentation">Qua</li>
                        <li class="nav-item" role="presentation">Qui</li>
                        <li class="nav-item" role="presentation">Sex</li>
                        <li class="nav-item" role="presentation">Sab</li>
                        <li class="nav-item" role="presentation">Dom</li>
                      </ul>
                    <div class="border-grey bg-white p-3 tab-content">
                        <div class="tab-pane active" id="seg" role="tabpanel" aria-labelledby="seg-tab">
                          <div class="row">
