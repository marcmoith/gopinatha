            ...
            <figure class="text-center">
                <blockquote class="blockquote">
                  <p class="text-primary">
                    No que diz respeito ao empenho, ao compromisso, ao esforço, 
                    à dedicação, não existe meio termo. Ou você faz uma coisa bem feita ou não faz.
                  </p>
                </blockquote>
                <figcaption class="blockquote-footer text-primary">
                  Ayrton Senna <cite title="">(1960-1994)</cite>
                </figcaption>
            </figure>
        </div>
    </div>
