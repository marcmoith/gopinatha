...
<html>
    ...
    <style type="text/css">
        ...
        background-image: url("assets/images/banners/identidade-visual.jpg");
...
<nav aria-label="breadcrumb" style="margin-left: 12px; margin-top: 16px;">
  <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" style="font-family: padrao;" aria-current="page">Identidade Visual</li>
  </ol>
</nav>
...
<div class="quem-somos" style="padding: 10px 10px 10px 10px;">
    ...
    <h1 class="page-header" style="margin-left: 10px;">Identidade Visual</h1>
    <div class="box-01-total" style="margin-left:-450px; margin-top: -58px"> 
        <div class="box-01">
            <div class="conteudo">
                <div class="linha">
                    <div class="barra" style="background-color: darkturquoise;">
                    </div>
                </div> <!-- Linha -->
            </div>
        </div>
...
-moz-box-shadow: 2px 3px 4px 0px rgba(0,0,0,0.75);">
            <figure class="text-center">
                <blockquote class="blockquote">
                  <p>
                    Qualquer atividade torna-se criativa e prazerosa quando quem a pratica se interessa 
                    por fazê-la bem feita, ou até melhor.
                  </p>
                </blockquote>
                <figcaption class="blockquote-footer">
                  John Updike <cite title="Source Title">(1932-2009)</cite>
                </figcaption>
            </figure>
        </div>
    </div>
